<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于微信小程序的校园兼职系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='xueshengyonghu'" class="input-group">
			   <div class="label">手机号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shoujihao" class="input" type="text" placeholder="手机号">
			   </div>
			 </div> -->
			<el-form-item label="手机号" class="input" v-if="tableName=='xueshengyonghu'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='xueshengyonghu'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='xueshengyonghu'">
			...
			<el-form-item label="昵称" class="input" v-if="tableName=='xueshengyonghu'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='xueshengyonghu'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      if((!this.ruleForm.shoujihao) && `xueshengyonghu` == this.tableName){
        this.$message.error(`手机号不能为空`);
        return
      }
      if(`xueshengyonghu` == this.tableName && this.ruleForm.shoujihao&&(!this.$validate.isMobile(this.ruleForm.shoujihao))){
        this.$message.error(`手机号应输入手机格式`);
        return
      }
      if((!this.ruleForm.mima) && `xueshengyonghu` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `xueshengyonghu` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.nicheng) && `xueshengyonghu` == this.tableName){
        this.$message.error(`昵称不能为空`);
        return
      }
      if(`xueshengyonghu` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
