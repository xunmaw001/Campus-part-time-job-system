<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="兼职分类" prop="jianzhifenlei">
          <el-input v-model="ruleForm.jianzhifenlei" 
              placeholder="兼职分类" clearable  :readonly="ro.jianzhifenlei"></el-input>
        </el-form-item>
        <div v-else>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jianzhibaoming/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jianzhibaomingCrossAddOrUpdateFlag = false;
						 this.parent.search();
