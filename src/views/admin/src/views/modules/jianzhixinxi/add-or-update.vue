<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="兼职分类" prop="jianzhifenlei">
        ...
        <div v-else>
          <el-form-item class="input" label="兼职分类" prop="jianzhifenlei">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="店家地址" prop="dianjiadizhi">
          <el-input v-model="ruleForm.dianjiadizhi" 
              placeholder="店家地址" clearable  :readonly="ro.dianjiadizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="店家地址" prop="dianjiadizhi">
              <el-input v-model="ruleForm.dianjiadizhi" 
                placeholder="店家地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="招聘内容" prop="zhaopinneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="招聘内容"
                  v-model="ruleForm.zhaopinneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhaopinneirong" label="招聘内容" prop="zhaopinneirong">
                    <span>{{ruleForm.zhaopinneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
