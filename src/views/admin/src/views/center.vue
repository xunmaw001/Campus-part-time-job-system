<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='xueshengyonghu'"  label="手机号" prop="shoujihao">
          <el-input v-model="ruleForm.shoujihao" readonly              placeholder="手机号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='xueshengyonghu'"  label="昵称" prop="nicheng">
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='xueshengyonghu'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
          ...
          @change="xueshengyonghutouxiangUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='xueshengyonghu'"  label="邮箱" prop="youxiang">
...
export default {
  ...
  methods: {
    xueshengyonghutouxiangUploadChange(fileUrls) {
    ...
    onUpdateHandler() {
      if((!this.ruleForm.shoujihao)&& 'xueshengyonghu'==this.flag){
        this.$message.error('手机号不能为空');
        return
      }
      if( 'xueshengyonghu' ==this.flag && this.ruleForm.shoujihao&&(!isMobile(this.ruleForm.shoujihao))){
      ...
      if((!this.ruleForm.nicheng)&& 'xueshengyonghu'==this.flag){
      ...
      if( 'xueshengyonghu' ==this.flag && this.ruleForm.youxiang&&(!isEmail(this.ruleForm.youxiang))){
